...
adminRouter.get("/stats/assinaturas-ativas", async (req: Request, res: Response, next: NextFunction) => {
  try {
...
adminRouter.get("/fornecedores", async (req: Request, res: Response, next: NextFunction) => {
  try {
...
adminRouter.get("/fornecedores/:id/vendas-pratos", async (req: Request, res: Response, next: NextFunction) => {
  try {
